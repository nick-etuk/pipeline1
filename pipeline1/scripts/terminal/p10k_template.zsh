...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    ap1_eb_env              # aws elastic beanstalk environment (https://aws.amazon.com/elasticbeanstalk/)
  ...
  typeset -g POWERLEVEL9K_AP1_SHOW_ON_COMMAND='aws|awless|terraform|pulumi|terragrunt'

  # POWERLEVEL9K_AP1_CLASSES is an array with even number of elements. The first element
  # in each pair defines a pattern against which the current AWS profile gets matched.
  # More specifically, it's P9K_CONTENT prior to the application of context expansion (see below)
  # that gets matched. If you unset all POWERLEVEL9K_AP1_*CONTENT_EXPANSION parameters,
  # you'll see this value in your prompt. The second element of each pair in
  # POWERLEVEL9K_AP1_CLASSES defines the profile class. Patterns are tried in order. The
  # first match wins.
  #
  # For example, given these settings:
  #
  #   typeset -g POWERLEVEL9K_AP1_CLASSES=(
  #     '*prod*'  PROD
  #     '*test*'  TEST
  #     '*'       DEFAULT)
  #
  ...
  # You can define different colors, icons and content expansions for different classes:
  #
  #   typeset -g POWERLEVEL9K_AP1_TEST_FOREGROUND=28
  #   typeset -g POWERLEVEL9K_AP1_TEST_VISUAL_IDENTIFIER_EXPANSION='⭐'
  #   typeset -g POWERLEVEL9K_AP1_TEST_CONTENT_EXPANSION='> ${P9K_CONTENT} <'
  typeset -g POWERLEVEL9K_AP1_CLASSES=(
      # '*prod*'  PROD    # These values are examples that are unlikely
      # '*test*'  TEST    # to match your needs. Customize them as needed.
      '*'       DEFAULT)
  typeset -g POWERLEVEL9K_AP1_DEFAULT_FOREGROUND=7
  typeset -g POWERLEVEL9K_AP1_DEFAULT_BACKGROUND=1
  # typeset -g POWERLEVEL9K_AP1_DEFAULT_VISUAL_IDENTIFIER_EXPANSION='⭐'

  # AWS segment format. The following parameters are available within the expansion.
  #
  # - P9K_AP1_PROFILE  The name of the current AWS profile.
  # - P9K_AP1_REGION   The region associated with the current AWS profile.
  typeset -g POWERLEVEL9K_AP1_CONTENT_EXPANSION='${P9K_AP1_PROFILE//\%/%%}${P9K_AP1_REGION:+ ${P9K_AP1_REGION//\%/%%}}'

  #[ ap1_eb_env: aws elastic beanstalk environment (https://aws.amazon.com/elasticbeanstalk/) ]#
  # AWS Elastic Beanstalk environment color.
  typeset -g POWERLEVEL9K_AP1_EB_ENV_FOREGROUND=2
  typeset -g POWERLEVEL9K_AP1_EB_ENV_BACKGROUND=0
  # Custom icon.
  # typeset -g POWERLEVEL9K_AP1_EB_ENV_VISUAL_IDENTIFIER_EXPANSION='⭐'
